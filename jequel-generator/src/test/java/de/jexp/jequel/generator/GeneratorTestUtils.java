...
public class GeneratorTestUtils {
	...
	public static final String CREATE_TABLE_ARTICLE = "create memory table article (" + "oid numeric(10), "
			+ "name varchar(50), " + "active date, " + "article_no integer," + "constraint pk_article primary key (oid)"
			+ ")";
...
//        jdbcTemplate.execute("COMMENT ON COLUMN article.active IS '@deprecated'");
	...
	static String readTestFile(final String testPath, final String testPackage, final String testClass)
			throws IOException {
	...
	public static Map<String, TableMetaData> readSerializedTableMetaData(final File file)
			throws IOException, ClassNotFoundException {
		return readObject(file);
	}

	public static SchemaMetaData readSerializedSchemaMetaData(final File file)
			throws IOException, ClassNotFoundException {
		return readObject(file);
	}
	...
	static SchemaMetaData setUpLoaderWithDatabase() throws SQLException {
	...
	public static void createTestMetaDataSourceFile(final String testPackage, final String className,
			final boolean multiFile) throws SQLException {
		createTestMetaDataSourceFile(testPackage, className, multiFile, setUpLoaderWithDatabase());
	}

	public static void createTestMetaDataSourceFile(final String testPackage, final String className,
			final boolean multiFile, final SchemaMetaData schemaMetaData) {
